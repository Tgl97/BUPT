          ...
          <div class="layui-field-box">
            <table class="site-table table-hover">
              ...
              <tr>
                ...
                <th style="text-align: center;">服务从机数</th>
                <th style="text-align: center;">接受从机请求数</th>
              </tr>
              </thead>
              <tbody>
              ...
              <tr>
                ...
                <td>ON</td>
                <c:choose>
                  <c:when test="${e.hostWorkMode == 1}">
                    <td>升温</td>
                  </c:when>
                  <c:when test="${e.hostWorkMode == 0}">
                    <td>降温</td>
                  </c:when>
                </c:choose>
                <td>${e.nowServeSlaveNumber}</td>
                <td>${e.acceptedSlaveRequestNumber}</td>
              </tr>
              </c:forEach>
              </tbody>
            </table>
